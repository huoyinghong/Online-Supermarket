                ...
                <div class="row">
                        <div class="col-md-4">
                                <div class="mb-3">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" runat="server" id="CateNameTb" />
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="col-md-8">
                                <asp:GridView ID="CategoryList" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" Width="645px" OnSelectedIndexChanged="CategoryList_SelectedIndexChanged">
